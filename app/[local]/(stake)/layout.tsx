...
import Menu from './stake/components/Menu';
import StakeWagmiProvider from './stake/components/StakeWagmiProvider';
type Props = {
		...
		<StakeWagmiProvider>
			<Box className="stake-layout">
				<Box className="sticky top-0 z-50 w-full border-b border-white/10 dark:bg-zinc-950/95 shadow-[0_2px_20px_rgba(0,0,0,0.15)] backdrop-blur-xl">
					<Box className="mx-auto flex w-full items-center justify-between py-2 sm:px-2 lg:px-3">
