...
export default async function Layout({ children, params }: Props) {
	...
	return (
		<Box className="stake-layout">
			<Box className="sticky top-0 z-50 w-full border-b border-white/10 dark:bg-zinc-950/95 shadow-[0_2px_20px_rgba(0,0,0,0.25)] backdrop-blur-xl">
				<Box className="mx-auto flex w-full max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
